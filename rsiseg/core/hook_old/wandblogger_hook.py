...
from rsiseg.datasets.pipelines import LoadImageFromFile, PercentileNormalize, Compose, ClipNormalize, MultiDomainClipNormalize
    ...
    def _add_ground_truth(self, runner):
        ...
        for t in self.val_dataset.pipeline.transforms:
            if isinstance(t, LoadImageFromFile):
                img_loader.append(t)
            if isinstance(t, PercentileNormalize):
                img_loader.append(t)
            if isinstance(t, ClipNormalize):
                img_loader.append(t)
            if isinstance(t, MultiDomainClipNormalize):
                img_loader.append(t)
